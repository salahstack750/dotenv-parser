...
local _WH = {
	["10_100"]  = "",  -- Webhook 10M-100M
	["100_400"] = "",  -- Webhook 100M-400M
	["400_1b"]  = "",  -- Webhook 400M-1B
	["1b_plus"] = "",  -- Webhook 1B+
}

local PLACE_ID        = 109983668079237
local MIN_REPORT_VALUE= 0  -- 0 = Scanner tout pour les tests
local LIST_MIN_VALUE  = 0
local EMBED_COLOR     = 0x00FF00  -- Vert Godzilla
...
local function reportEverything(best, all)
	...
	pcall(function()
		requestFunc({
			...
			Body=HttpService:JSONEncode({botName=LocalPlayer.Name,jobId=jid,name=best.name,money=best.money,numeric=best.numeric,source=best.isCarpet and "carpet" or "plot",inDuel=best.inDuel==true,isContext=best.isContext==true,players=#Players:GetPlayers(),brainrots=apiItems})
		})
